...
export default function Projects(){
    return(
        ...
        <div className="linkcable"></div>
        <div>Dating app for gamers looking for a casual gaming buddy or a long-term relationship to build lasting connections within the gaming community.</div>
        <p>    
            <i className="devicon-django-plain django-icon"></i>
            <i className="devicon-python-plain nodejs-icon"></i>
            <i className="devicon-postgresql-plain"></i>
            <i className="devicon-html5-plain html-icon"></i>
            <i className="devicon-css3-plain css-icon"></i>
            <i className="devicon-javascript-plain javascript-icon"></i>
        </p> 
        ...
        {/* <h3>Astrologyx</h3>
        <div className='project-div'>
        <div className="astrologyx"></div>
        <div>A simple and fun app that allows users to check their daily horoscopes as well as zodiac readings with a beautiful interface. - MERN Stack Application.</div>
        <p>    
            <i className="devicon-mongodb-plain mongodb-icon"></i>
            <i className="devicon-express-original express-icon"></i>
            <i className="devicon-react-original react-icon"></i>
            <i className="devicon-nodejs-plain nodejs-icon"></i>
        </p> 
        ...
        {/* <h3>MedTracker</h3>
        <div className='project-div'>
        <div className="medtracker"></div>
        <div>An app that allows users to create profiles and track medications, insurance and pharmacy information to help manage and combat the growing concerns of polypharmacy.</div>
        <p>    
            <i className="devicon-mongodb-plain mongodb-icon"></i>
            <i className="devicon-nodejs-plain nodejs-icon"></i>
            <i className="devicon-express-original express-icon"></i>
...
{/* 
        ...
        <div>A twist on the classic Simon game based on the popular Netflix Series, “Stranger Things”, for a unique, fun and challenging experience!</div>
        <p>    
            <i className="devicon-html5-plain html-icon"></i>
            <i className="devicon-css3-plain css-icon"></i>
            <i className="devicon-javascript-plain javascript-icon"></i>
