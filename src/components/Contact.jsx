...
export default function Contact () {
  ...
  return (
    <>
    <h2>Contact Me!</h2>
    <p className='contact-text'>Have questions, suggestions, or comments? <br /> Feel free to drop me a message or send me an email at nguyen.vy11@gmail.com and I will get back to you as soon as possible!</p>
